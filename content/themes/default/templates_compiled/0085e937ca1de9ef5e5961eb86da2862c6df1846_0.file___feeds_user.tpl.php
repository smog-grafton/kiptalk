<?php
/* Smarty version 5.8.0, created on 2026-05-08 19:44:39
  from 'file:__feeds_user.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fe3d2771af16_95007474',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0085e937ca1de9ef5e5961eb86da2862c6df1846' => 
    array (
      0 => '__feeds_user.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fe3d2771af16_95007474 (\Smarty\Template $_smarty_tpl) {
      ...
      <?php if ($_smarty_tpl->getValue('_user')['monetization_plan']) {?>
        <div class="mt10">
          <span class="badge bg-info">
            <?php if ($_smarty_tpl->getValue('_user')['monetization_plan']['discounted_price']) {
echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_user')['monetization_plan']['discounted_price']);
}
if ($_smarty_tpl->getValue('_user')['monetization_plan']['discounted_price']) {?><span style="text-decoration: line-through;" class="ml5"><?php }
echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_user')['monetization_plan']['price']);
if ($_smarty_tpl->getValue('_user')['monetization_plan']['discounted_price']) {?></span><?php }?> / <?php if ($_smarty_tpl->getValue('_user')['monetization_plan']['period_num'] != '1') {
