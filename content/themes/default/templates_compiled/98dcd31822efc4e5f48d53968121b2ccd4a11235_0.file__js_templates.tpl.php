...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdb228ad6293_80011275',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '98dcd31822efc4e5f48d53968121b2ccd4a11235' => 
    array (
      0 => '_js_templates.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fdb228ad6293_80011275 (\Smarty\Template $_smarty_tpl) {
...
><!-- Publisher --><!-- AI --><?php if ($_smarty_tpl->getValue('system')['ai_text_credit_enabled'] || $_smarty_tpl->getValue('system')['ai_image_credit_enabled']) {
echo '<script'; ?>
 id="ai-credit" type="text/template"><div class="modal-header"><h6 class="modal-title"><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ai",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Buy Credits");?>
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="ai/credit.php"><div class="modal-body"><div class="row"><div class="col-12 col-md-5"><div class="card-balance"><p><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Wallet Balance");?>
</p><p class="card-balance-value text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_wallet_balance']);?>
</p><div class="d-flex justify-content-center mt20"><button class="btn btn-md btn-dark w-100" data-toggle="modal" data-url="#wallet-replenish"><i class="fa fa-wallet fa-fw mr5"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add Funds");?>
</button></div></div></div><div class="col-12 col-md-7"><div class="bs-callout bs-callout-warning mt0">{{#is_text}}<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Each word costs");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getValue('system')['ai_generated_word_cost'];?>
</span> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("credits");?>
{{/is_text}}{{#is_image}}<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Each image costs");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getValue('system')['ai_generated_image_cost'];?>
</span> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("credits");?>
{{/is_image}}</div><div class="form-group"><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("How much credits you want to add?");?>
</label><input type="number" class="form-control js_ai-credits-amount" name="amount" placeholder="0" {{#is_text}} data-node-cost="<?php echo $_smarty_tpl->getValue('system')['ai_generated_word_cost'];?>
" {{/is_text}} {{#is_image}} data-node-cost="<?php echo $_smarty_tpl->getValue('system')['ai_generated_image_cost'];?>
" {{/is_image}}><div class="form-text x-hidden js_ai-credits-cost-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("This will cost you");?>
 <?php echo $_smarty_tpl->getValue('system')['system_currency_symbol'];?>
<span class="js_ai-credits-cost"></span></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div></div></div><div class="modal-footer"><input type="hidden" name="handle" value="{{handle}}"><button type="submit" class="btn btn-dark"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Buy");?>
</button></div></form><?php echo '</script'; ?>
><?php }?><!-- AI --><!-- Posts & Comments --><?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array("index","profile","page","group","event","post","photo","market","blogs","directory","search","share","reels"))) {?><!-- Comments --><?php echo '<script'; ?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=send_tip"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Wallet Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_wallet_balance']);?>
</span></div><div class="form-group"><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_funding"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Funding Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_funding_balance']);?>
</span></div><div class="form-group"><label class="form-label" for="amount"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->getValue('system')['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->getValue('system')['system_currency_symbol'];?>
</span><input class="form-control" type="text" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="submit" class="btn btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Continue");?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_monetization"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Monetization Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_monetization_balance']);?>
</span></div><div class="form-group"><label class="form-label" for="amount"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->getValue('system')['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->getValue('system')['system_currency_symbol'];?>
</span><input class="form-control" type="text" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="submit" class="btn btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Continue");?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"><div id="payment-summry"><div class="plr20 text-start"><?php if ($_smarty_tpl->getValue('page') != "wallet") {?><div class="mb15" id="payment-coupon-form"><div class="w-100 d-flex gap-2"><input type="text" class="form-control form-control-sm" placeholder="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Promo code');?>
" name="payment-promo-code" id="payment-promo-code" data-price="{{price}}" data-handle="{{handle}}"><button type="button" class="btn btn-light btn-sm js_payment-apply-coupon"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Apply");?>
</button><button type="button" class="btn btn-light btn-sm js_payment-clear-coupon x-hidden"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Clear");?>
</button></div><div class="alert alert-success mt10 x-hidden" id="payment-coupon-success"></div><div class="alert alert-danger mt10 x-hidden" id="payment-coupon-error"></div></div><div class="divider mtb15"></div><?php }?><div class="mb15"><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
</span><span class="float-end" id="payment-amount">{{price}}</span></div><?php if ($_smarty_tpl->getValue('system')['payment_vat_enabled']) {?><div class="mb15"><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("VAT");?>
 <small class="text-muted"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('get_payment_vat_percentage')();?>
%</small></span><span class="float-end" id="payment-vat" data-initial-value="{{vat}}">{{vat}}</span></div><?php }
if ($_smarty_tpl->getValue('system')['payment_fees_enabled']) {?><div class="mb15"><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Fees");?>
 <small class="text-muted"><?php echo $_smarty_tpl->getValue('system')['payment_fees_percentage'];?>
%</small></span><span class="float-end" id="payment-fees" data-initial-value="{{fees}}">{{fees}}</span></div><?php }?><div class="mb15"><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Discount");?>
 <small class="text-muted"><span id="payment-discount-percentage">0</span>%</small></span><span class="float-end text-success"><span class="mr5">-</span><span id="payment-discount-value">0</span></span></div><div class="divider mtb15"></div><div class="mb15"><span><strong><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Total");?>
</strong></span><span class="float-end"><strong id="payment-total" data-initial-value="{{total_printed}}">{{total_printed}}</strong></span></div><div class="divider mtb15"></div><?php if ($_smarty_tpl->getValue('system')['wallet_enabled']) {
if ($_smarty_tpl->getValue('page') == "packages" && $_smarty_tpl->getValue('system')['packages_enabled'] && $_smarty_tpl->getValue('system')['packages_wallet_payment_enabled']) {?>{{^wallet}}<div><small class="text-muted"><i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Note: Paying via wallet credit will not be charged any VAT or fees");?>
</i></small><div class="divider mtb15"></div></div>{{/wallet}}<?php }
...
if ($_smarty_tpl->getValue('system')['2checkout_enabled']) {?><div class="col-12 col-sm-6 mb10"><div class="d-grid"><button class="btn btn-md btn-payment" data-toggle="modal" data-url="#twocheckout" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "total": "{{total}}" }'><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"2co",'class'=>"mr5",'width'=>"20px",'height'=>"20px"), (int) 0, $_smarty_current_dir);
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("2Checkout");?>
</button></div></div><?php }
if ($_smarty_tpl->getValue('system')['authorize_net_enabled']) {?><div class="col-12 col-sm-6 mb10"><div class="d-grid"><button class="btn btn-md btn-payment" data-toggle="modal" data-url="#authorizenet" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "total": "{{total}}" }'><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"authorize.net",'class'=>"mr5",'width'=>"20px",'height'=>"20px"), (int) 0, $_smarty_current_dir);
...
if ($_smarty_tpl->getValue('system')['cashfree_enabled']) {?><div class="col-12 col-sm-6 mb10"><div class="d-grid"><button class="btn btn-md btn-payment" data-toggle="modal" data-url="#cashfree" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "total": "{{total}}" }'><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"cashfree",'class'=>"mr5",'width'=>"20px",'height'=>"20px"), (int) 0, $_smarty_current_dir);
...
</label><input class="form-control" name="billing_zip_code" type="text" required></div></div></div><!-- error --><div class="alert alert-danger mt15 mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="token" value="" /><input type="hidden" name="promo_code" value="{{promo_code}}" /><input type="hidden" name="handle" value="{{handle}}"><input type="hidden" name="id" value="{{id}}"><input type="hidden" name="price" value="{{price}}"><input type="hidden" name="total" value="{{total}}"><button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Cancel");?>
</button><button type="submit" class="btn btn-primary"><i class="fa fa-check-circle mr10"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Pay");?>
</button></div></form><?php echo '</script'; ?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Authorize.Net");?>
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form id="authorizenet_form"><div class="modal-body"><div class="heading-small mb20"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Card Info");?>
</div><div class="pl-md-4 pr-md-4"><div class="row"><div class="form-group col-md-12"><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Card Number");?>
</label><input class="form-control" name="card_number" type="text" required autocomplete="off"></div><div class="form-group col-md-4"><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Exp Month");?>
</label><select class="form-select" name="card_exp_month" required><?php
$_smarty_tpl->assign('i', null);$_smarty_tpl->tpl_vars['i']->step = 1;$_smarty_tpl->tpl_vars['i']->total = (int) ceil(($_smarty_tpl->tpl_vars['i']->step > 0 ? 12+1 - (1) : 1-(12)+1)/abs($_smarty_tpl->tpl_vars['i']->step));
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?></select></div><div class="form-group col-md-6"><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Zip Code");?>
</label><input class="form-control" name="billing_zip_code" type="text" required></div></div></div><!-- error --><div class="alert alert-danger mt15 mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="promo_code" value="{{promo_code}}" /><input type="hidden" name="handle" value="{{handle}}"><input type="hidden" name="id" value="{{id}}"><input type="hidden" name="price" value="{{price}}"><input type="hidden" name="total" value="{{total}}"><button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Cancel");?>
</button><button type="submit" class="btn btn-primary"><i class="fa fa-check-circle mr10"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Pay");?>
</button></div></form><?php echo '</script'; ?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form id="banktransfer_form"><div class="modal-body"><div class="page-header rounded bank-transfer mb30"><div class="circle-1"></div><div class="circle-2"></div><div class="inner text-left"><?php if ($_smarty_tpl->getValue('system')['bank_name']) {?><h2 class="mb20"><i class="fa fa-university mr5"></i><?php echo $_smarty_tpl->getValue('system')['bank_name'];?>
</h2><?php }
