...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdb23c901156_69107125',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '76d1e135da32a0127d718a8d09b3787eee0ee98f' => 
    array (
      0 => '_publisher.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fdb23c901156_69107125 (\Smarty\Template $_smarty_tpl) {
...
">
          ...
          <div class="colored-text-wrapper">
            ...
            <textarea style="display: none;" <?php if ($_smarty_tpl->getValue('_modal_mode')) {?>autofocus<?php }?> dir="auto" class="js_autosize js_mentions js_publisher-scraper" data-init-placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("What is on your mind? #Hashtag.. @Mention.. Link..");?>
...
?>
              ...
              <?php }?>
              <?php if (!$_smarty_tpl->getValue('_quick_mode')) {?>
                <?php if ($_smarty_tpl->getValue('system')['ai_images_enabled']) {?>
                  <li class="col-md-6">
                    <div class="publisher-tools-tab link js_publisher-tab" data-tab="ai_image" data-toggle="modal" data-size="large" data-url="ai/modal.php?handle=image">
                      <?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ai_image",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
                      <span class="text-gradient"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Generate Image");?>
</span>
                      <span class="float-end"><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ai",'class'=>"main-icon",'width'=>"18px",'height'=>"18px"), (int) 0, $_smarty_current_dir);
?></span>
                    </div>
                  </li>
                <?php }?>
                <?php if ($_smarty_tpl->getValue('system')['ai_posts_enabled']) {?>
                  <li class="col-md-6">
                    <div class="publisher-tools-tab link js_publisher-tab" data-tab="ai" data-toggle="modal" data-size="large" data-url="ai/modal.php?handle=post">
                      <?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ai_post",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
                      <span class="text-gradient"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Generate Post");?>
</span>
                      <span class="float-end"><?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ai",'class'=>"main-icon",'width'=>"18px",'height'=>"18px"), (int) 0, $_smarty_current_dir);
?></span>
                    </div>
...
?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getValue('system')['blogs_enabled'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','page','group','event'))) {?>
                  <li class="col-md-6">
...
?>
 ...
 <?php if ($_smarty_tpl->getValue('system')['paid_products_enabled']) {?><span class="badge rounded-pill text-bg-danger"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Paid");?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getValue('system')['funding_enabled'] && $_smarty_tpl->getValue('_handle') == "me") {?>
                  <li class="col-md-6">
...
?>
 ...
 <?php if ($_smarty_tpl->getValue('system')['paid_jobs_enabled']) {?><span class="badge rounded-pill text-bg-danger"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Paid");?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getValue('system')['courses_enabled'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','page','group','event'))) {?>
                  <li class="col-md-6">
...
'></button>
                ...
                <!-- collaborative post -->
                <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','group','event')) && $_smarty_tpl->getValue('user')->_data['can_add_collaborative_posts']) {?>
                  <div class="form-table-row mb10" id="collaborative-toggle-wrapper">
                    <div class="avatar">
                      <?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"collaborative",'class'=>"main-icon",'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
                    </div>
                    <div>
