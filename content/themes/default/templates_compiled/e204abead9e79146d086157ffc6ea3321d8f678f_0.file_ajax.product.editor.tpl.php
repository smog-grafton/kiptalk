<?php
/* Smarty version 5.8.0, created on 2026-05-10 04:07:12
  from 'file:ajax.product.editor.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_6a000470d426d7_66143440',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e204abead9e79146d086157ffc6ea3321d8f678f' => 
    array (
...
function content_6a000470d426d7_66143440 (\Smarty\Template $_smarty_tpl) {
...
'></button>
            ...
            <input type="hidden" class="js_x-uploader-input" name="product_file" value="<?php echo $_smarty_tpl->getValue('post')['product']['product_file_source'];?>
">
          </div>
          <div class="form-text">
...
" class="form-control">
 ...
 (<?php echo $_smarty_tpl->getValue('system')['system_currency'];?>
        ...
        <input name="price" type="number" class="form-control" value="<?php echo $_smarty_tpl->getValue('post')['product']['price'];?>
">
      </div>
    </div>
    <!-- total item units -->
