...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdb41464bad2_43180779',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3c21de774964a4c369a94568987ff28f296b69c3' => 
    array (
      0 => '__feeds_post.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fdb41464bad2_43180779 (\Smarty\Template $_smarty_tpl) {
...
"><?php echo $_smarty_tpl->getValue('post')['time'];?>
    ...
    <div class="post-body">
      ...
      <?php if ($_smarty_tpl->getValue('post')['is_collaborative'] && ($_smarty_tpl->getValue('post')['i_collaborative'] || ($_smarty_tpl->getValue('post')['is_paid'] && $_smarty_tpl->getValue('post')['author_id'] == $_smarty_tpl->getValue('user')->_data['user_id']))) {?>
        <div class="post-collaborative-alert">
          <i class="fa-solid fa-circle-info mr5"></i>
          <?php if ($_smarty_tpl->getValue('post')['i_collaborative']) {?>
            <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("You are collaborating on this post");?>
 <?php if ($_smarty_tpl->getValue('post')['is_paid']) {?> & <?php }?>
          <?php }?>
          <?php if ($_smarty_tpl->getValue('post')['is_paid']) {?>
            <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Collaborators will receive");?>
 <?php echo $_smarty_tpl->getValue('post')['collaborative_percent'];?>
% <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("of the revenue");?>
