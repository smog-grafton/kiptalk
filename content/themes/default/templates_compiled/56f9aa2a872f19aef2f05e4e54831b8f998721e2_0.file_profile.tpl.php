<?php
/* Smarty version 5.8.0, created on 2026-05-08 10:34:23
  from 'file:profile.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdbc2fd8b3d3_12754634',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '56f9aa2a872f19aef2f05e4e54831b8f998721e2' => 
    array (
      0 => 'profile.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fdbc2fd8b3d3_12754634 (\Smarty\Template $_smarty_tpl) {
...
?>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->getValue('profile')['can_write_blogs']) {?>
          <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/<?php echo $_smarty_tpl->getValue('profile')['user_name'];?>
...
?>
            <span class="ml5 d-none d-xxl-inline-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Blogs");?>
</span>
          </a>
        <?php }?>
...
?>
            <span class="ml5 d-none d-xxl-inline-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Store");?>
</span>
          </a>
        <?php }?>
...
&node_type=profile" data-size="large">
 ...
 <?php if ($_smarty_tpl->getValue('profile')['user_monetization_discount_enabled']) {
echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('profile')['user_monetization_min_price']*(1-$_smarty_tpl->getValue('profile')['user_monetization_discount_percent']/100));
}
if ($_smarty_tpl->getValue('profile')['user_monetization_discount_enabled']) {?><span style="text-decoration: line-through;" class="ml5"><?php }
echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('profile')['user_monetization_min_price']);
if ($_smarty_tpl->getValue('profile')['user_monetization_discount_enabled']) {?></span><?php }?>
                </button>
              </div>
            <?php }?>
            <!-- subscribe -->
        ...
        <?php } elseif ($_smarty_tpl->getValue('view') == "photos") {?>
          ...
          <div class="col-12">
            <?php if ($_smarty_tpl->getValue('profile')['needs_subscription']) {?>
              <?php $_smarty_tpl->renderSubTemplate('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>'profile','node_id'=>$_smarty_tpl->getValue('profile')['user_id'],'price'=>$_smarty_tpl->getValue('profile')['user_monetization_min_price'],'discount_enabled'=>$_smarty_tpl->getValue('profile')['user_monetization_discount_enabled'],'discount_percent'=>$_smarty_tpl->getValue('profile')['user_monetization_discount_percent']), (int) 0, $_smarty_current_dir);
?>
            <?php } else { ?>
              <div class="card panel-photos">
                <div class="card-header with-icon with-nav">
...
$foreach21Backup = clone $_smarty_tpl->getVariable('blog');
?>
...
?>
                  <?php
$_smarty_tpl->setVariable('blog', $foreach21Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                </ul>

                <!-- see-more -->
                <div class="alert alert-post see-more js_see-more" data-get="blogs_profile" data-id="<?php echo $_smarty_tpl->getValue('profile')['user_id'];?>
">
                  <span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("See More");?>
</span>
                  <div class="loader loader_small x-hidden"></div>
