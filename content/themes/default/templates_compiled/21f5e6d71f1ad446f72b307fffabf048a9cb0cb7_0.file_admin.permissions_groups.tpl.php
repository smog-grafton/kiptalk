<?php
/* Smarty version 5.8.0, created on 2026-05-08 21:23:06
  from 'file:admin.permissions_groups.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fe543a5db674_83185237',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '21f5e6d71f1ad446f72b307fffabf048a9cb0cb7' => 
    array (
...
function content_69fe543a5db674_83185237 (\Smarty\Template $_smarty_tpl) {
...
?>
            ...
            <div>
              <div class="form-label h6"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Collaborative Posts");?>
</div>
              <div class="form-text d-none d-sm-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Can Add Collaborative Posts");?>
</div>
            </div>
            <div class="text-end">
...
?>
        ...
        <div class="heading-small mb20">
          <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("AI Permissions");?>
...
?>
            ...
            <div>
              ...
              <div class="form-text d-none d-sm-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Can generate posts using AI");?>
</div>
            </div>
            <div class="text-end">
...
?>
            ...
            <div>
              ...
              <div class="form-text d-none d-sm-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Can generate blogs using AI");?>
</div>
            </div>
            <div class="text-end">
...
?>
            ...
            <div>
              ...
              <div class="form-text d-none d-sm-block"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Can generate images using AI");?>
</div>
            </div>
            <div class="text-end">
...
?>
              ...
              <div class="text-end">
                <label class="switch" for="collaborative_posts_permission">
                  <input type="checkbox" name="collaborative_posts_permission" id="collaborative_posts_permission" <?php if ($_smarty_tpl->getValue('data')['collaborative_posts_permission']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
...
?>
              ...
              <div class="text-end">
                <label class="switch" for="ai_posts_permission">
                  <input type="checkbox" name="ai_posts_permission" id="ai_posts_permission" <?php if ($_smarty_tpl->getValue('data')['ai_posts_permission']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
...
?>
              ...
              <div class="text-end">
                <label class="switch" for="ai_blogs_permission">
                  <input type="checkbox" name="ai_blogs_permission" id="ai_blogs_permission" <?php if ($_smarty_tpl->getValue('data')['ai_blogs_permission']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
...
?>
              ...
              <div class="text-end">
                <label class="switch" for="ai_images_permission">
                  <input type="checkbox" name="ai_images_permission" id="ai_images_permission" <?php if ($_smarty_tpl->getValue('data')['ai_images_permission']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
