...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdb23c96b770_81365491',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a143d2a1931c1e8c77ef444aa793cb7074dbcc09' => 
    array (
      0 => '_posts.tpl',
      1 => 1778233710,
      2 => 'file',
...
function content_69fdb23c96b770_81365491 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/home/u636854834/domains/kiptalk.com/public_html/content/themes/default/templates';
?><!-- posts-filter -->
<?php if (!$_smarty_tpl->getValue('_no_filter')) {?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Recent Updates");
    ...
    <div class="float-end">
      ...
      <?php if ($_smarty_tpl->getValue('system')['newsfeed_location_filter_enabled'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array('index','group','event')) && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('view'),array('scheduled','boosted_posts')) && !$_smarty_tpl->getValue('_filter')) {?>
        <a href="#" data-bs-toggle="dropdown" class="dropdown-toggle countries-filter">
...
/blogs/new" class="btn btn-sm btn-primary">
      ...
      <?php } elseif ($_smarty_tpl->getValue('_filter') == "funding") {?>
        <?php if ($_smarty_tpl->getValue('system')['funding_enabled'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
      ...
      <?php } elseif ($_smarty_tpl->getValue('_filter') == "course") {?>
        <?php if ($_smarty_tpl->getValue('system')['courses_enabled'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
...
} else { ?>all<?php }?>" <?php if ($_smarty_tpl->getValue('_category')) {?>data-category="<?php echo $_smarty_tpl->getValue('_category');?>
