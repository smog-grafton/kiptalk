...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69fdb41474c9f3_57794188',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '320c46d4927eee7bfb887219a8d6b9cd2fb8852f' => 
    array (
...
function content_69fdb41474c9f3_57794188 (\Smarty\Template $_smarty_tpl) {
...
" class="blog-category text-no-underline"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('_post')['blog']['category_name']);?>
 ...
 <?php if ($_smarty_tpl->getValue('_post')['video']['category_name']) {?><a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/watch/category/<?php echo $_smarty_tpl->getValue('_post')['video']['category_id'];?>
/<?php echo $_smarty_tpl->getValue('_post')['video']['category_url'];?>
" class="blog-category text-no-underline"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('_post')['video']['category_name']);?>
</a><?php }?>
...
"><?php echo $_smarty_tpl->getValue('_post')['wall_fullname'];?>
      ...
      <?php } elseif ($_smarty_tpl->getValue('_post')['is_collaborative']) {?>
        <i class="fa fa-users ml5 mr5"></i>
        <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("collaborated with");?>

        <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('_post')['collaborative_users'], '_user', true);
...
$foreach2Backup = clone $_smarty_tpl->getVariable('_user');
?>
          <span class="js_user-popover" data-type="user" data-uid="<?php echo $_smarty_tpl->getValue('_user')['user_id'];?>
">
            <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/<?php echo $_smarty_tpl->getValue('_user')['user_name'];?>
"><?php echo $_smarty_tpl->getValue('_user')['user_fullname'];?>
</a>
          </span>
          <?php if (!$_smarty_tpl->getVariable('_user')->last) {?>
            <span class="text-muted">,</span>
          <?php }?>
        <?php
$_smarty_tpl->setVariable('_user', $foreach2Backup);
}
...
<?php } else { ?>
  ...
  <?php if ($_smarty_tpl->getValue('_post')['needs_age_verification']) {?>
...
?>
  <?php } elseif ($_smarty_tpl->getValue('_post')['needs_payment']) {?>
    <?php $_smarty_tpl->renderSubTemplate('file:_need_payment.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('post_id'=>$_smarty_tpl->getValue('_post')['post_id'],'price'=>$_smarty_tpl->getValue('_post')['post_price'],'discounted_price'=>$_smarty_tpl->getValue('_post')['post_price_discounted'],'paid_text'=>$_smarty_tpl->getValue('_post')['paid_text'],'paid_image'=>$_smarty_tpl->getValue('_post')['paid_image']), (int) 0, $_smarty_current_dir);
?>
  <?php } elseif ($_smarty_tpl->getValue('_post')['needs_subscription']) {?>
    <?php $_smarty_tpl->renderSubTemplate('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>$_smarty_tpl->getValue('_post')['needs_subscription_type'],'node_id'=>$_smarty_tpl->getValue('_post')['needs_subscription_id'],'price'=>$_smarty_tpl->getValue('_post')['needs_subscription_price'],'discount_enabled'=>$_smarty_tpl->getValue('_post')['needs_subscription_discount_enabled'],'discount_percent'=>$_smarty_tpl->getValue('_post')['needs_subscription_discount_percent'],'subscriptions_image'=>$_smarty_tpl->getValue('_post')['subscriptions_image']), (int) 0, $_smarty_current_dir);
?>
  <?php }?>
